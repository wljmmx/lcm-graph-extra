...
function dump(label, restr, len = 1800) {
  console.log('\n########## ' + label + ' ##########');
...
dump('CompactResult', 'type CompactResult');
dump('ContextEngineMaintenanceResult', 'type ContextEngineMaintenanceResult');
dump('TranscriptTurnAdmission', 'type TranscriptTurnAdmission');
dump('TranscriptEntryAnchor', 'type TranscriptEntryAnchor');