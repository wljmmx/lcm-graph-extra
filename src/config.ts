...
export const PluginConfigSchema = Type.Object({
  ...
  qmdMcpQueryTimeout: Type.Number({ default: 30_000, minimum: 1_000, description: 'QMD MCP/REST 查询超时（ms）。局域网远程 qmd + 本地 LLM rerank 单次可达 10s+，默认 30s（SD-DEF-3；原 15s 偏紧）' }),
